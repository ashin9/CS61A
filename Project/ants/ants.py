...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        cur_index = 0
        while cur_place and cur_place is not beehive:
            
            if self.min_range <= cur_index <= self.max_range:
                if cur_place.bees:
        ...
        # if self.name == 'Short':
        #     cur_index = 0
        #     while cur_place and cur_place is not beehive and cur_index < 3:
        #         cur_index += 1
        #         if cur_place.bees:
        #             return rANTdom_else_none(cur_place.bees)
        #     cur_place = cur_place.entrance
        ...
        #     # 跳过前五个
        #     cur_index = 0
        #     while cur_place and cur_place is not beehive and cur_index < 5:
        #         cur_index += 1
        #         cur_place = cur_place.entrance
        #     # 从第六个开始
        #     while cur_place and cur_place is not beehive:
...
# END Problem EC
    ...
    def action(self, gamestate):
        ...
        if self.imposter:
            ...
            while cur_place:
                if cur_place.ant and not cur_place.ant.double_buff:
                    cur_place.ant.double_buff = True
...
def apply_status(status, bee, length):
    ...
    # 参考别人思路
    original_act = bee.action
    new_act = status(bee.action, bee)
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self, beehive):
        ...
        while cur_place and not isinstance(cur_place, Hive):
            # 排除 LaserAnt
            if cur_place.ant and not isinstance(cur_place.ant, LaserAnt):
                insect_dict[cur_place.ant] = distance
